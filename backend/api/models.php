...
$stmt = getDB()->query('SELECT key_name, display_name, color_class, is_stream, supports_files, description, base_energy FROM models WHERE is_active = 1 ORDER BY sort_order ASC, display_name ASC');
